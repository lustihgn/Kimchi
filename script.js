...
const icons = ["⭐","🌟","✨","☆","★","✧","✦","⋆"];
const cards = [
  { img:"anh1.jpg", text:"❤️Chúc Kchi năm mới sẽ có thêm thật là nhiều niềm vui ❤️" },
  ...
  { img:"anh5.jpg", text:"💕Mong chị Kchi sẽ luôn nhận được sự yêu thương và trân trọng 💕" },
  { img:"anh6.jpg", text:"☁️Chúc cho Kchi có một năm nhẹ nhàng và ít phải lo nghĩ nhe ☁️" },
